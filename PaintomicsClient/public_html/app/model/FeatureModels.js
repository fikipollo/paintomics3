...
OmicValue.loadFromJSON = function(jsonObject) {
    ...
    if (jsonObject.inputName !== undefined) {
        omicValueInstance.inputName = jsonObject.inputName;
    }
    if (jsonObject.omicName !== undefined) {
        omicValueInstance.omicName = jsonObject.omicName;
    }
    if (jsonObject.relevant !== undefined) {
        omicValueInstance.relevant = jsonObject.relevant;
    }
