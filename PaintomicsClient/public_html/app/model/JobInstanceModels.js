...
function JobInstance(jobID) {
    ...
    */
    ...
    this.loadFromJSON = function (jsonObject) {
        ...
        if (jsonObject.jobID !== undefined) {
            this.jobID = jsonObject.jobID;
        }
        if (jsonObject.stepNumber !== undefined) {
            this.stepNumber = jsonObject.stepNumber;
        }
        if (jsonObject.organism !== undefined) {
            this.organism = jsonObject.organism;
        }
        if (jsonObject.summary !== undefined) {
            this.summary = jsonObject.summary;
        }
        if (jsonObject.mappingSummary !== undefined) {
            this.mappingSummary = jsonObject.mappingSummary;
        }
        if (jsonObject.geneBasedInputOmics !== undefined) {
        ...
        if (jsonObject.compoundBasedInputOmics !== undefined) {
